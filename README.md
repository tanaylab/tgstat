...
#>  [1] tgstat_1.0.0    cowplot_0.8.0   stringr_1.2.0   dplyr_0.7.2    
...
#> [31] highlight_0.4.7.1    roxygen2_6.0.1       codetools_0.2-15    
#> [34] crayon_1.3.2         withr_2.0.0          commonmark_1.2      
#> [37] nlme_3.1-131         jsonlite_1.5         gtable_0.2.0        
#> [40] magrittr_1.5         stringi_1.1.5        bindrcpp_0.2        
#> [43] getopt_1.20.0        xml2_1.1.1           rjson_0.2.15        
#> [46] tools_3.3.2          forcats_0.2.0        glue_1.1.1          
#> [49] hms_0.3              pkgload_0.0.0.9000   parallel_3.3.2      
#> [52] yaml_2.1.14          colorspace_1.3-2     rvest_0.3.2         
